...
<ContentWrapper>
	...
	<form>
		<div class="relative z-0 w-full mb-20 group">
			<label for="title" class="text-xl sm:text-2xl font-medium text-gray-900">미팅 이름</label>
			<input
				name="title"
				class="block w-full py-2 text-sm sm:text-xl text-gray-700 border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:border-gray-500 focus:ring-0 peer"
		...
		<div class="relative z-0 w-full mb-20 group">
			<label for="description" class="text-xl sm:text-2xl font-medium text-gray-900"
				>미팅 세부사항</label
			>
			<textarea
				name="description"
